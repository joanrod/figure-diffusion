...
class VQLPIPSWithDiscriminatorOCR(nn.Module):
    def __init__(self, disc_start, codebook_weight=1.0, pixelloss_weight=1.0,
        ...
        self.ocr_perceptual_loss = OCR_CRAFT_LPIPS().eval() # TO DO: Create a parameter to chose the type of OCR Loss    
        ...
        if disc_loss == "hinge":
            ...
            raise ValueError(f"Unknown GAN loss '{disc_loss}'.")
        print(f"VQLPIPSWithDiscriminatorOCR running with {disc_loss} loss.")
        self.disc_factor = disc_factor
        self.discriminator_weight = disc_weight
        self.disc_conditional = disc_conditional
