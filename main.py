# main file for training latent diffusion models, addapted from taming-transformers and latent-diffusion repos. 
# Thanks to those communities and authors for the making this awesome work public
